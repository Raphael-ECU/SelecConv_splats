...
def find_and_graph_Normals(coneSize, neighbors, fileName, displayPointCloud = False):
...
find_and_graph_Normals(4, 25, 'Scaniverse_chair.ply')
find_and_graph_Normals(0.25, 25, 'Plushie.ply')
find_and_graph_Normals(2, 25, 'Table.ply')
